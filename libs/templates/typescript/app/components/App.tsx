        ...
        <div className="container mx-auto my-10">
          <div className="flex">
            ...
            <div className="flex-auto text-right nav">
              ...
              <NavLink to="/what-next" className="ml-3 text-blue-lightest bg-blue hover:bg-blue-dark border rounded px-5 py-2 no-underline">What Next?</NavLink>
            </div>
          </div>
        </div>
      </div>
      <div className="item flex-grow">
        <div className="container mx-auto my-10">
          <Switch>
            ...
            <Route path="/what-next" component={WhatNext}/>
          </Switch>
        </div>
      </div>
